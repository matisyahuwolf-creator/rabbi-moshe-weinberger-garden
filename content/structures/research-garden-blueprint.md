---
title: "Torah Research Blueprint"
description: "A practical architecture for deepening the Quartz site as a Torah research garden."
tags:
  - "structure"
  - "research-garden"
  - "blueprint"
...
| Themes | `themes/` | Group concepts into living sugyos and interpretive clusters. |
| Research areas | `areas/` | Make the garden bigger than one speaker or one series. |
| Maps | `maps/` | Show the network and status of the research. |
| Structures | `structures/` | Turn a network into a walkable learning path. |
...
- [[areas/sefarim-and-text-cycles|Sefarim and Text Cycles]]
...
- [[areas/torah-source-library|Torah Source Library]]
- [[areas/torah-research-infrastructure|Torah Research Infrastructure]]
...
- Create essay pages only after the source and concept links are stable.
- Keep broad categories small enough to scan and deep enough to return to.

## Return

- [[maps/research-garden-atlas|Torah Research Atlas]]
- [[index|Networked Torah Research]]
